...
def main():
    ...
    parser.add_argument('-s', type=int, metavar='num of surrogates', dest="surrogates",
                        help="Number of surrogates for estimation, overrides the corresponding option in the config file.")
    parser.add_argument('-r', type=str, metavar='num of regions', dest="dataset_sub", default="",
    ...
    parser.add_argument('-S', dest="save_out", action="store_true",
