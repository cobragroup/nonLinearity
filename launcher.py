...
# nle = NLE(config_file="config.ini", bins=8, surrogates=99, cache="cache", save_out=20, dataset="eso245_cra_strin",workers=23)

# for region in regions:
#     nle.estimate(display=False, dataset_sub=str(region), extended_stats=True, compute_shadow=True)
